...
let lacReqs = document.getElementById("lac");
let cssdReqs = document.getElementById("cs");
...
for (let lacCourse of lacCourses) {
    ...
    lacReqs.innerHTML +=
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-8">
                    <h5 class="card-title">${lacCourse["Course Name"]}</h5>
                </div>
                <div class="col">
                    <p class="text-end">${lacCourse["Credit Hours"]} hours</p>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <p class="text-end text-muted">${lacCourse["Semester Offered"]}</p>
                </div>
            </div>

            <a class="link" type="button" data-bs-toggle="collapse" data-bs-target="#${convertID(lacCourse["Course ID"])}"
                aria-expanded="false" aria-controls="${convertID(lacCourse["Course ID"])}">
                Course Description
            </a>
            <div class="collapse small mt-2" id="${convertID(lacCourse["Course ID"])}">
                <div class="card-text">
...
for (let cssdCourse of cssdCourses) {
    console.log(cssdCourse);
    cssdReqs.innerHTML +=
        `<div class="card my-3">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-8">
                    <h5 class="card-title">${cssdCourse["Course Name"]}</h5>
                </div>
                <div class="col">
                    <p class="text-end">${cssdCourse["Credit Hours"]} hours</p>
                </div>
            </div>

            <div class="row">
                <div class="col-6">
                    <p class="card-subtitle">${cssdCourse["Course ID"]}</p>
                </div>
                <div class="col">
                    <p class="text-end text-muted">${cssdCourse["Semester Offered"]}</p>
                </div>
            </div>

            <a class="link" type="button" data-bs-toggle="collapse" data-bs-target="#${convertID(cssdCourse["Course ID"])}"
                aria-expanded="false" aria-controls="${convertID(cssdCourse["Course ID"])}">
                Course Description
            </a>
            <div class="collapse small mt-2" id="${convertID(cssdCourse["Course ID"])}">
                <div class="card-text">
                    ${cssdCourse["Course Description"]}
                </div>
            </div>
        </div>
    </div>`;
